...
export default function Hero() {
  return (
    <section className="relative min-h-[80vh] flex flex-col justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-zinc-500/10 rounded-full blur-[120px] mix-blend-screen animate-pulse-slow" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-slate-500/10 rounded-full blur-[100px] mix-blend-screen animate-pulse-slow delay-1000" />
      ...
      <div className="container max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col w-full">
             ...
             <div className="flex flex-col mb-6">
                <span className="text-foreground/70 font-medium tracking-wide text-lg mb-2">Hi, I&apos;m</span>
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-light text-foreground/90">
              Bachelor&apos;s in <span className="font-semibold text-foreground">Information Systems</span>
            </h2>
        ...
        >
           <div className="relative w-96 h-96">
             {/* Glowing Ring */}
             <div className="absolute inset-0 rounded-full border border-foreground/10 animate-[spin_10s_linear_infinite]" />
             <div className="absolute inset-4 rounded-full border border-foreground/5 animate-[spin_15s_linear_infinite_reverse]" />
